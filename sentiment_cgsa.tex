...
The authors considered a tweet as positive or negative if its overall
polarity score was greater than 25 and the subjectivity value was more
than 0.5.  This way, they achieved an accuracy of~77.3\% on the
manually annotated subset of \citeauthor{Go:09}'s corpus, and reaching
74.2\% on the IMDB corpus~\cite{Maas:11}.
