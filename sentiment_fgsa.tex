...
best to mitigate this effect (early stopping and higher regularization
parameters).  Another notable tendency, which can be observed both on
the training and test sets, is that the recall of the CRF system is
generally lower than its precision.  This again can be attributed to
the high variance of the classifier.
