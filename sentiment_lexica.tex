...
This time, we can observe a clear superiority of Takamura et al.'s
...
This is, for instance, the case for the method by \citet{Kim:04} and
the min-cut approach by \citet{Rao:09}, whose performance with the
native Kim-Hovy seed set is on par with their results achieved using
the Turney-Littman seeds.  The label-propagation and the random walk
algorithms can even strongly benefit from the seeds provided by
\citet{Kim:04}.  The remaining two methods---\citet{Hu:04} and
\citet{Esuli:06c}---work best in combination with the initial polarity
set proposed by \citet{Esuli:06c}.
