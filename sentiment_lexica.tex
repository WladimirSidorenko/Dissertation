...
\subsubsection{Effect of Word Embeddings}\label{subsec:snt-lex:eowet}
...
\subsubsection{Effect of Vector Normalization}\label{subsec:snt-lex:eowet}
...
\section{Effect of the Seed Sets}\label{subsec:snt-lex:eoss}
