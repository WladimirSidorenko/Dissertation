...
freely available annotation tool, which you can download
at:
...
\begin{itemize}
\item it has to be \textbf{polar}, \ie{} it shall always reflect
  either positive or negative attitude to its respective target.
  Neutral, non-evaluative statements such as \textit{Ich glaube, er
    wird heute fr\"uher kommen} (\textit{I think he will be earlier
    today}) do not represent \texttt{sentiment}s;
...
express a relative subjective judgment, \ie{} an object is regarded
to be either better or worse than another one, but we usually do not
know whether the author actually likes or dislikes any of them.  To
