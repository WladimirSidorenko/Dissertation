...
\begin{table*}
  \begin{center}
    ...
    \begin{tabular}{p{0.162\columnwidth} % first columm
      ...
      Training Set & 0.555 & 0.747 & 0.637 & 0.463 & 0.688 & 0.553 %
      & 0.431 & 0.78 & 0.553 & 0.582\\
      %% Tag        Precision    Recall F-Measure
      %% O             77.77%    82.91%    80.26%
      ...
      Test Set & 0.317 & 0.28 & 0.297 & 0.231 & 0.313 & 0.265 %
      & 0.218 & 0.236 & 0.226 & 0.263\\

      \multicolumn{11}{c}{\cellcolor{cellcolor}GRU}\\
      Training Set & 0.475 & 0.665 & 0.554 & 0.439 & 0.545 %
      & 0.486 & 0.387 & 0.674 & 0.492 & 0.511\\
      Test Set & 0.3 & 0.255 & 0.276 & 0.236 & 0.259 & 0.247%
      & 0.222 & 0.239 & 0.23 & 0.251\\\bottomrule
    \end{tabular}
    \egroup
...
\textbf{Results} The results of these methods are shown in
