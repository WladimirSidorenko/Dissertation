...
lexical-syntactic features, which simultaneously combined several
...
\begin{table*}
  \begin{center}
    ...
    \end{tabular}
    \egroup
    \caption{Results of fine-grained sentiment analysis with
...
lexicon-based approach to this objective, in which they first
determenied the occurrences of the given target in text, then anlyzed
the immediate context of these occurrences, looking there for
subjective terms from their manually compiled lexicon; and, finally,
determined the overall polarity of the opinion, judging by the
predetermined polarity score of the lexicon term and a set of
heuristic rules which accounted for contextual changes.

An alternative way of classifying subjective opinions and their
holders was proposed by \citet{Bethard:04}, who utilized the lexicon
of~\citet{Wiebe:03} enriched with the method of~\citet{Hatzivassi:97}
for the former task and an SVM classifier working on constituency
trees for the latter objective.
...
Kobayashi et al., 2007; Joshi and Penstein-Rosé, 2009; Wu et
al., 2009 Wiegand and Klakow (2010) Ruppenhofer et al. (2008)
