...
tokens as valid opinionated items.  Even though our original
...
by default allowed for such distinctions.  The results of these
...
Surprisingly, the latter group was among the most difficult ones for
...
parameters.  The results of this computation are shown in
Table~\ref{sent:tbl:corr-coeff}.
\begin{table}[thb!]
  \begin{center}
    \bgroup \setlength\tabcolsep{0.47\tabcolsep} \scriptsize
    \begin{tabular}{|p{0.23\columnwidth}|%
          *{4}{>{\centering\arraybackslash}p{0.2\columnwidth}|}} % next five columns
      \hline
      & \multicolumn{4}{c|}{{\cellcolor{cellcolor}}
        Annotation Element}\\
      \multirow{-2}{0.2\columnwidth}{\centering\bfseries\cellcolor{cellcolor}
        Selection Category}\\\hline
          %% Topic & & & & \\
          %% Formal & & & & \\
          \hline
    \end{tabular}
