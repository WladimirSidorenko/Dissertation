...
\begin{center}
  \begin{table}[htb!]
    \begin{tabular}{lcp{0.957\clmnwidth}}\toprule
      \textbf{Attribute} & \textbf{Value} & \multicolumn{1}{c}{\textbf{Meaning}}\\\midrule
      %%%%%%%%%%%%%%%%%%%

      \multirow[c]{3}{*}[-2.5cm]{polarity} & \textit{positive} & sentiment expresses a positive attitude to
      ...
      polar attitude has its literal meaning.\\\bottomrule
    \end{tabular}
...
\begin{center}
  \begin{table}[htb!]
    \begin{tabular}{lcp{0.895\clmnwidth}}\toprule
      \textbf{Attribute} & \textbf{Value} & \multicolumn{1}{c}{\textbf{Meaning}}\\\midrule
...
\begin{center}
  \begin{table}
    \begin{tabular}{lcp{0.875\clmnwidth}}\toprule % noqa
      \textbf{Attribute} & \textbf{Value} & \multicolumn{1}{c}{\textbf{Meaning}}\\\midrule
      polar-term-ref & \textit{$\longrightarrow$\newline(directed
