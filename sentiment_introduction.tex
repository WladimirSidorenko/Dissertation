...
further enhanced her system with the possibility to predict subjective
sentences in stories automatically.  This work was allegedly one of
the first experiments on the automatic prediction of sentiments on the
level of single sentences.
...
mentions of a product and sales spikes for that product, also
...
and negative opinions about each particular product aspect.  Finally,
\citet{Funk:08} proposed a supervised SVM-system to perform two- and
five-way polarity classification of product reviews and subsequently
fed these predictions into a business intelligence application.
...
\emph{tired}, \emph{happy} etc.).  The gold labels for their
...
and age groups; as well as a high idiosyncracy and diversity of the
