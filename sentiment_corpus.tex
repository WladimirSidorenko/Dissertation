...
\item
  ...
  \begin{itemize}
    ...
    \item
      ...
      which had to be drawn from a target to its respective opinion in
      cases when the target element was located outside of its
...
similar tendency can be observed for the proportional metric: here,
the agreement on sentiments has gained 30.73 percentage points,
...
the scale were to be penalized more than close divergences, we opted
...
sentiments, specifying the polarity of opinionated terms as their
...
being labeled.  As to the reliability of sentiments, we hypothesize
...
last stage and the rest of the statistics presented in this section
...
which did not contain any terms from this resource.  As shown in the
evaluation part of this section, introducing such bias in the sampled
data might significantly affect the resulting distribution, omitting
many relevant phenomena of interest.  Furthermore, the annotations of
this dataset only provide information about the polarity of single
lexical items or complete microblogs, losing valuable details about
targets, holders of opinions, and compositionality effects of
modifying elements.
...
this section, we have presented a comprehensive corpus of 7,996 German
...
polarity, intensity, sarcasm etc., whose values also were to be
...
28.5 percent.  The smallest improvement was shown by intensifiers and
was largely due to the diverging treatment of exclamation marks: the
first expert was skipping these entities during the annotation,
...
The polarity kappa on sentiments achieved 58.8\%, whereas the
corresponding scores for polar terms reached remarkable 87.12\%.  The
Krippendorff's alpha for the intensity of these items run up to
73.54\% and 78.79\% respectively, which, according to
\citet{Krippendorff:07}, already allows for tentative conclusions,
being quite close to the boundary of nearly perfect scores.
...
coefficients for the distribution and agreement level of sentiments
and polar terms on the one hand and topical and formal categories of
the microblogs in our corpus on the other.
