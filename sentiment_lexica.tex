...
\texttt{derived\_from} (especially between adverbs and
adjectives/adjective satellites).  The links between adjectives and
nouns are mixed though, featuring both \texttt{related\_to} and
\texttt{derived\_from} connections.  As we should see later, these
links are crucial for breaking part-of-speech dependencies of seed
sets in the cases when all seeds belong to the same PoS class.
