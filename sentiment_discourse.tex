...
\begin{example}[Error Made by the \textsc{Root} System]\label{snt:dasa:exmp:root-error}
  %% <<<	gold:	negative
  %% >>>	predicted:	neutral
  %% Die NSA weiss auch von dir ... Nützt uns auch nichts . \%NegSmiley
\end{example}
...
classifier.  Likewise, the LCRF system can hardly beat any other
approach, reaching only 0.239 macro\F{}.
