...
\chapter{Gradient Computation for the Optimized Projection Line}\label{chap:apdx:lex-grad}
...
&=\sum_{\vec{p}_+}\sum_{\vec{p}_-}\gamma\vec{b}_j%
\left(\frac{(\vec{p}_+ - \vec{p}_-)_j\vec{b}^2 - 2\gamma\vec{b}_j}{\vec{b}^4}\vec{b}_j%
...
$j$, we can estimate the final form of the gradient as follows:
