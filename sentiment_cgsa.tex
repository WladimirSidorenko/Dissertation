...
In order to estimate the quality of these methods on the PotTS and
SB10k datasets, we reimplemented the approaches of~\citet{Taboada:11},
\citet{Musto:14}, \citet{Jurek:15}, and \citet{Kolchyna:15}, and
applied these systems to the test set tweets described in
Section~\ref{sec:cgsa:data}.
