...
As noted by many researchers, sentiment analysis is a highly
domain-dependent task: systems pre-trained for specific topics and
specific domains do not neatly generalize to other descriptions and
other text genres.  A natural questiion that arises in this context is
which of the domains should be tackled first in this case.

While earlier SA works were primaroly concentrating on narratives and
formal newspaper texts, it soon became evident that social media are
both a much more desired target for mining opinions.  Indeed, unlike
most newswire documents

 a virtual lack of any moderation on the most existing
CMC platforms results in Ungezwungenheit at expressing one's emotions
and feelings.  This factor combined with a tremenduous popularity of
CMC channels among people makes SM a fruitful soil for the
proliferation of sentiments.

\begin{inparaenum}[\itshape i)\upshape]
  \item a virtual lack of any censorship and, as a consequence,
  \item the informality of the language
\end{inparaenum}
\citet{Derks:07} \citet{Thelwall:12}
