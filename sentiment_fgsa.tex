...
Somewhat surprisingly, tree-structured CRFs show worse scores than the
traditional linear models, which can partially be explained by the
errors in the syntactic trees which are produced on this domain.
