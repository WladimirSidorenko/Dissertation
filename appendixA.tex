...
better or worse than another one, but we usually do not know whether
the author actually likes or dislikes any of them.  To distinguish
such cases, we have introduced a special \texttt{comparison} value for
the \texttt{polarity} attribute of this element, which you should use
...
status is unknown.  These are sentences like \textit{Ich wei\ss{}
  ...
  like my brother}).  In this example, neither we nor the author
actually know whether the author likes or dislikes her brother.
...
(\textit{I don't think that he has deserved this award}), which
express author's disagreement with positive evaluations and,
consequently, act as negative judgments.  Special care should be taken
when dealing with questions and subjunctive sentences (see FAQ Section
in the extended
