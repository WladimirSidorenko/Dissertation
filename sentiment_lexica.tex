...
\begin{table}[h]
  \begin{center}
    ...
    \begin{tabular}{p{0.11\columnwidth} % first columm
      ...
      % 280
      % positive                   0.770601             0.101975                 0.180115
      % negative                   0.316327             0.023100                 0.043056
      % neutral                    0.963279             0.998582                 0.980613
      % Macro-average              0.683402             0.374552                 0.401261
      % Micro-average              0.961889             0.961701                 0.961795

      PCA & 280 & \textbf{0.771} & 0.102 & 0.18 & %
        0.316 & 0.023 & 0.043 & %
        0.963 & \textbf{0.999} & 0.981 & %
        0.401 & 0.962\\
