...
After obtaining the results for the most popular fine-grained
sentiment analysis systems with the (mostly) standard settings, we
decided to investigate the impact of different training factors on the
net scores of these approaches.  For this purpose, we reran the
experiments, changing one aspect of the training at a time, and
reestimated the scores on the development data (in order to keep the
test set undisclosed).  The results of these experiments are presented
below.
...
%% Tag        Precision    Recall F-Measure
%% O             74.86%    83.85%    79.10%
%% SENTIMENT     34.57%    36.65%    35.58%
%% SOURCE        31.68%    33.75%    32.68%
%% TARGET        35.51%    41.95%    38.46%

%% GRU (Test Set)
%% Tag        Precision    Recall F-Measure
%% O             74.12%    86.22%    79.72%
%% SENTIMENT     34.70%    30.44%    32.43%
%% SOURCE        25.62%    25.65%    25.63%
%% TARGET        27.97%    20.25%    23.49%
...
\begin{table*}
  \begin{center}
    ...
    \begin{tabular}{p{0.162\columnwidth} % first columm
      ...
      GRU & \stddev{} & \stddev{} & \stddev{} & %
      \stddev{} & \stddev{} & \stddev{0.02} & %
      \stddev{} & \stddev{} & \stddev{0,03} & 0.25\stddev{0.01}\\\bottomrule
    \end{tabular}
    \egroup
    \caption{Results of fine-grained sentiment analysis for narrow and
      wide annotation interpretations.}
