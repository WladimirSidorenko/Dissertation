  ...
  \begin{center}
    ...
    \begin{tabular}{p{0.162\columnwidth} % first columm
      ...
      Precision & Recall & \F{} & & \\\midrule
       ...
       % Taboada Commands:
       % -----------------
       % cgsa_sentiment train -t musto -l cgsa/data/lexicons/sws.manual.txt \
       ...
       % Taboada Results:
       % ----------------
       % f1_abs: 0.416703; f1_cnt: 0.229631; f1_mean: 0.416719
       % best F1: 0.416719; self._thresholds: [-0.00039999999999999975, 0.00030000000000000014];
       % General Statistics:
       % precision    recall  f1-score   support
       % negative       0.25      0.15      0.18       287
       % neutral       0.37      0.70      0.49       558
       % positive       0.46      0.21      0.29       680
       % avg / total       0.39      0.38      0.34      1525
       % Macro-Averaged F1-Score (Positive and Negative Classes): 23.81%
       % Micro-Averaged F1-Score (All Classes): 37.9016%
       ...
       % General Statistics:
       % precision    recall  f1-score   support
       % positive       0.46      0.26      0.34       680
       % negative       0.23      0.19      0.21       287
       % neutral       0.37      0.60      0.46       558
       % avg / total       0.38      0.37      0.36      1525
       % Macro-Averaged F1-Score (Positive and Negative Classes): 27.29%
       % Micro-Averaged F1-Score (All Classes): 37.2459%
...
% Thresholds:
% Taboada: [-0.00039999999999999975, 0.00030000000000000014] (mean scores);
% Musto: [-8.571428571428569e-05, 0.0005882352941176471];
%
%
