...
of these options---the RMSProp technique of~\citet{Tieleman:12}---as
this algorithm showed both a faster convergence and better
classification results.

Another important factor that could significantly influence the
training results, were the initial values of models' parameters.  As
shown by~\citet{He:15}, an inappropriate initialization of neural
...
orthogonal initialization for all linear transformation matrices, and
applied uniform He sampling~\cite{He:15} for setting the initial
values of bias vectors.
