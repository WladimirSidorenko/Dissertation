...
effect on the prediction of sources and targets of sentiments, we
decided to investigate whether redefining the way these links were
established in the model would help improve the results.  For this
purpose, we implemented three possible extensions to the traditional
first-order linear-chain CRF model, which are shown in
Figure~\ref{fig:snt:ho-crf}:
\begin{itemize}
...
\begin{figure*}
  ...
  \end{subfigure}
\caption{\emph{Feature weights for states and transitions of the
      part-of-speech example.}\label{fig:snt:ho-crf}}
\end{figure*}
...
\begin{table*}
  \begin{center}
    ...
    \begin{tabular}{p{0.12\columnwidth} % first columm
      ...
      Sentiment & 0.584 & 0.559 & 0.54 & 0.57 & 0.587 & 0.606 & 0.43 &  \\
      Source & 0.525 & 0.458 & 0.424  & 0.503 & 0.546 & 0.548 & 0.317 &  \\
      Target & 0.521 & 0.513 & 0.501 & 0.519 & 0.544 & 0.605 & 0.305 &  \\

      \multicolumn{9}{c}{\cellcolor{cellcolor}Development Set}\\

      Sentiment & 0.278 & 0.285 & 0.281 & 0.335 & 0.252 & 0.253 & 0.314 &  \\
      Source & 0.328 & 0.314 & 0.303  & 0.263 & 0.298 & 0.306 & 0.256 &  \\
      Target & 0.259 & 0.218 & 0.222 & 0.216 & 0.219 & 0.188 & 0.205 &  \\\bottomrule
    \end{tabular}
    \egroup
    \caption{Results of fine-grained sentiment analysis with different
