...
brain.  Later on, their conception was also put into question by
...
narratology, we first of all should name Am\'elie Rorty
(\citeyear{Rorty:80}) and Ann Banfield (\citeyear{Banfield:82}).
\citeauthor{Rorty:80} suggested that the directive power which
emotions exerted over perception was partly a function of their
essentially dramatic or narrative structure \citep[cf.][]{Sousa:14}.
\citeauthor{Banfield:82} investigated how author's and characters'
