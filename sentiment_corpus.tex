...
binary attribute, for which it only sufficed to estimate the number of
...
the scale were to be penalized more than divergencies which were close
to each other, we opted for the Krippendorff's $\alpha$-metric as it
allowed for making such distinctions.  The results of these
computations are shown in Table~\ref{tbl:attr-agrmnt}.
...
value of this attribute for complete sentiments.  Similar to
...
the respective $\kappa$-value for their polarity attained considerable
...
sentiments, but specified the polarity of opinionated terms as
contextual valence, i.e., polarity of the respective term after
possible modifications from the context, instead.
