...
In this vein, we estimated the precision, recall, and $F1$-score of
...
\begin{table}[h]
  \begin{center}
    ...
    \begin{tabular}{|p{0.165\columnwidth}| % first columm
        *{9}{>{\centering\arraybackslash}p{0.07\columnwidth}|} % next nine columns
        *{2}{>{\centering\arraybackslash}p{0.085\columnwidth}|}} % last two columns
      \hline
          ...
          \multirow{2}{0.09\columnwidth}{\centering Overall\newline Macro-$F1$} & %
          \multirow{2}{0.09\columnwidth}{\centering Overall\newline Micro-$F1$}\\\cline{2-10}
      ...
      48.5\stddev{17.1} & 32\stddev{11.3} & 37.6\stddev{11.9} & %
      57.5\stddev{6.3} & 95.3\stddev{0.9}\\
