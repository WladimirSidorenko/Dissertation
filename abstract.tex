...
communicated through these platforms.  Dealing with this abundance of texts in
manual way becomes out of the question nowadays.  But, unfortunately, existing
...
need more robust and more high-quality NLP programs which are able to process
even such ``unconventional'' linguistic variants as the Web language.  But in
order to build such programs, we first need to understand the nature of these
variants better.
