...
metrics \cite[cf.][]{Choi:06,Breck:07} .  The former method considers an
...
the recall of the assignment was estimated as:
\begin{equation*}
...
spans---and also penalized for erroneous and spurious labels, we
decided to use this measure throughout our subsequent experiments.
...
The main resons for the huge success of this model are:
\begin{enumerate}[1)]
...
factor calculated over all possible labels:
\begin{equation}
  Z =
...
The value of such attribute at position $m$ in the sequence
...
than in the transition case, as it reflects various properties of the
input sequence at the respective position, such as whether the current
token is capitalized or whether it begins with a specific prefix or
ends with a specific suffix.  This type of features commonly accounts
for the overwhelming majority of all attributes used in a CRF system.
...
\item and, finally, \emph{syntactic}, which included the dependency
  ...
  binary features reflecting whether the previos token in the sentence
