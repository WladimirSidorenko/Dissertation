...
\begin{figure*}[htb]
  \centering { \centering
        \begin{subfigure}{0.7\textwidth}
          \centering
          \includegraphics[width=\linewidth]{dasa_potts_edu_distribution.png}
      ...
      \centering
          {
            ...
            \begin{subfigure}{0.7\textwidth}
              \centering
              \includegraphics[width=\linewidth]{dasa_sb10k_edu_distribution.png}
  ...
  \centering
      {
        ...
        \begin{subfigure}{0.7\textwidth}
          \centering
          \includegraphics[width=\linewidth]{dasa_potts_rel_distribution.png}
      ...
      \centering
          {
            ...
            \begin{subfigure}{0.7\textwidth}
              \centering
              \includegraphics[width=\linewidth]{dasa_sb10k_rel_distribution.png}
...
\begin{figure}[htb!]
  {\centering
    \includegraphics[width=\linewidth]{dirichlet-process.png} }
...
\begin{figure}[htb]
  \begin{center}
    \includegraphics[height=15em,width=0.4\linewidth]{rdp.png}
...
\begin{subfigure}{\textwidth}
  \centering
  \includegraphics[width=\linewidth]{dasa-potts-bc-macro-F1.png}
  \caption{\texttt{Macro-\F{}}}\label{dasa:fig:potts-base-classifier-macro-F1}
\end{subfigure}\\
\begin{subfigure}{\textwidth}
  \centering
  \includegraphics[width=\linewidth]{dasa-potts-bc-micro-F1.png}
...
\begin{subfigure}{\textwidth}
  \centering
  \includegraphics[width=\linewidth]{dasa-sb10k-bc-macro-F1.png}
  \caption{\texttt{Macro-\F{}}}\label{dasa:fig:sb10k-base-classifier-macro-F1}
\end{subfigure}\\
\begin{subfigure}{\textwidth}
  \centering
  \includegraphics[width=\linewidth]{dasa-sb10k-bc-micro-F1.png}
...
\begin{subfigure}{\textwidth}
  \centering
  \includegraphics[width=\linewidth]{dasa-potts-macro-F1.png}
  \caption{\texttt{Macro-\F{}}}\label{dasa:fig:potts-rel-schemes-macro-F1}
\end{subfigure}\\
\begin{subfigure}{\textwidth}
  \centering
  \includegraphics[width=\linewidth]{dasa-potts-micro-F1.png}
...
\begin{subfigure}{\textwidth}
  \centering
  \includegraphics[width=\linewidth]{dasa-sb10k-macro-F1.png}
  \caption{\texttt{Macro-\F{}}}\label{dasa:fig:sb10k-rel-schemes-macro-F1}
\end{subfigure}\\
\begin{subfigure}{\textwidth}
  \centering
  \includegraphics[width=\linewidth]{dasa-sb10k-micro-F1.png}
