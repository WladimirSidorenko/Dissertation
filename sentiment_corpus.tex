...
form of a message might also suggest whether it is likely to be
emotional or not.
...
known polar phrases were by default more probable to express some sort
of subjective opinions.  To find such terms, we considered three major
...
tweets about the papal conclave, on the contrary, are rather suposed
to be objectve.  We will check later in Subsection
\ref{subsec:snt:iaa} whether the distribution of the annotated
sentiment elements correlates with this proportional split of groups
and topics.
...
from the complete population, we justify this with the wish to
