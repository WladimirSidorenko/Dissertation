...
manually labeled data, on which these conjectures can be tested.
...
proportional kappa---which were specifically adjusted to the
...
elements and disagreements of our experts in the corpus.
