...
\item assigning higher weights to the tokens in nuclei of RST trees,
  and finally
...
an offset to the decision boundary of this system, which increased
...
the help of Markov logic contraints; and finally \citet{Wang:13}, who
estimated the semantic orientation of a document by taking a linear
combination of the polarity scores of its EDUs, multiplying these
scores with automatically learned coefficients.
...
especially emphasize the work of \citet{Bhatia:15}, who presented two
