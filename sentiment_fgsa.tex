...
\begin{table}[hbt]
  \begin{center}
    ...
    \caption{Results of the feature ablation test.\\{\small\itshape
        Negative changes w.r.t. the original scores on the dev set are
        shown in \textsuperscript{\textcolor{red3}{red}}, and positive changes are depicted in
...
Due to an exponentially increasing running time, we restricted the
...
\begin{table*}
  \begin{center}
    ...
    \begin{tabular}{p{0.12\columnwidth} % first columm
      ...
      & 1 lcCRF & 2 lcCRF & 3 lcCRF & 4 lcCRF & %
      1 smCRF & 2 smCRF & 3 smCRF & 4 smCRF & 1 trCRF\\\midrule

      \multicolumn{10}{c}{\cellcolor{cellcolor}Training Set}\\

      Sentiment & 0.928 &  &  &  & 0.931 & 0.931 &  &  & \\
      Source & 0.886 &  &  &  & 0.869 & 0.886 &  &  & \\
      Target & 0.898 &  &  &  & 0.813 & 0.827 &  &  & \\\midrule

      \multicolumn{10}{c}{\cellcolor{cellcolor}Development Set}\\

      Sentiment &  &  &  &  & 0.395 & 0.385 &  &  & \\
      Source &  &  &  &  & 0.298 & 0.282 &  &  & \\
      Target &  &  &  &  & 0.287 & 0.309 &  &  & \\\bottomrule
    \end{tabular}
    \egroup
