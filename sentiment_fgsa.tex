...
A more efficient way of tackling this problem was proposed
by~\citet{Socher:13}.  In their work on predicting sentiment polarity
of single syntactic constituents and whole sentences, the authors
explored a recursive tensor-based approach, in which they computed the
semantic orientation of a given node bottom up by recursively
multiplying the embeddings of descendant leaves with a compositional
tensor, whose weights along with the vector representations of words
...
TODO: Tree-CRFs based on the dependency graphs were also used by
