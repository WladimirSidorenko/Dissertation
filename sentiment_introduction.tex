...
But before we delve into the odds and ends of contemporary sentiment
analysis, we first would like to make a short digression into the
history of this field, which would allow us to understand the modern
trends and theories better.

Like many other subdisciplines of computational linguistics, opinion
mining takes its roots from miltiple areas of research, such as
philosophy, psychology, cognitive sciences, and last but least
narratology and linguistics.

In philosophy, TODO:

In psychology: Evolutionary Theory of Emotion, James-Lange Theory of
Emotion, Cannon-Bard Theory of Emotion, Schachter-Singer Theory

In literary studies and linguistics, Theory of Narrative Sentences
...
corpora.  Notable contributions to this were done by \cite{Wiebe:03}
\cite{Wilson:03}.
