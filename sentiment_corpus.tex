...
matching \markable{sentiment}s and \markable{polar term}s.  The reason
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{sentiment_stat.png}
  \caption{\texttt{Sentiments}}\label{snt:fig:crp-sent-emo-distr-a}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{emo-expression_stat.png}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{sentiment_agreement.png}
  \caption{\texttt{Sentiments}}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{emo-expression_agreement.png}
...
$\rho$-score for \markable{sentiment}s is achieved by tweets
