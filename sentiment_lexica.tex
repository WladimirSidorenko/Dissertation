...
\begin{table}[h]
  \begin{center}
    ...
    \begin{tabular}{|p{0.162\columnwidth}| % first columm
      ...
      GPC & 24.03\stddev{7.91} & 46.39\stddev{11.22} & 31.08\stddev{8.24} & %
      21.95\stddev{8.06} & 41.64\stddev{10.62} & 28.09\stddev{8.27} & %
      98.01\stddev{0.51} & 94.26\stddev{1.03} & 96.09\stddev{0.49} & %
      51.75\stddev{4.71} & 92.3\stddev{0.92}\\

      SWS & 35.85\stddev{13.18} & 38.69\stddev{11.58} & 35.96\stddev{9.93} & %
      49.02\stddev{17.06} & 31.31\stddev{10.94} & \textbf{37.18}\stddev{11.55} & %
      97.51\stddev{0.54} & 97.84\stddev{1} & 97.67\stddev{0.48} & %
      \textbf{56.94}\stddev{6.2} & 95.38\stddev{0.89}\\

      ZPL & 36.38\stddev{12.3} & 21.3\stddev{7.16} & 26.3\stddev{8.02} & %
      41.05\stddev{15.55} & 23.27\stddev{8.66} & 29.03\stddev{10} & %
      96.96\stddev{0.64} & 98.73\stddev{0.33} & 97.84\stddev{0.34} & %
      51.06\stddev{4.4} & 95.67\stddev{0.64}\\

      GPC $\cap$ SWS $\cap$ ZPL & \textbf{54}\stddev{12.79} & %
      30.56\stddev{10.48} & \textbf{38.06}\stddev{10.14} & %

      \textbf{61.66}\stddev{17.84} & 21.59\stddev{9.12} & 31.16\stddev{11.3} & %
      97.13\stddev{0.62} & \textbf{99.25}\stddev{0.29} & \textbf{98.18}\stddev{0.32} & %
      55.8\stddev{5.43} & \textbf{96.39}\stddev{0.62}\\
...
As we can see, the relative placement of the best-performing systems
...
% Since all available sentiment lexica available for German involved an
% automatic translation with a subsequent manual revision and
% (optionally) some sort of heuristic extension, we decided to check
% whether the most popular methods for an automatic lexicon generation
% used for English could be a viable alternative to these approaches.
...
\subsubsection{Lexicon Generation Using Lexical Database}
