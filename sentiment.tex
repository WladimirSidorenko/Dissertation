...
to other subjects and other text genres.  A natural questiion that
...
represents a much more attractive goal for mining people's opinions.
The reason for this is a virtual absence of any moderation on the most
popular CMC services.  This lack of censorship allows users to be
forthright about their feelings when confabulating with their friends.
Combined with the great popularity that social networks experience
nowadays, this freedom of expressing one's thoughts makes social media
the arguably most fertile ground for disseminating sentiments.

\citet{Derks:08} \citet{Thelwall:12}
