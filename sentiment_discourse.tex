...
\begin{figure}[htbp]
  \begin{center}
    ...
    \end{tikzpicture}
    \caption{Example of an SDRT graph}
...
between contrastive and non-contrastive relations in the analyzed case
(even though it only predicts the former class for two percent of all
edges on the PotTS and SB10k data [see
...
\begin{figure}[htb]
  \begin{center}
    ...
    \caption[A plate diagram of Recursive Dirichlet Process]{A plate
      diagram of Recursive Dirichlet Process\\{\small (without the
...
\begin{table}[htb]
  \begin{center}
    ...
    \caption[Results of the DPLP parser on PCC~2.0]{Results of the
      DPLP parser on PCC~2.0 with different relation schemes\\}
