...
Another recursive approach was suggested by~\citet{Irsoy:14a}, who
explored deep bidirectional neural networks for predicting DSEe and
ESEs on the MPQA corpus.  In particular, they estimated the label $y$
of the $t$-th token as:
\begin{align*}
