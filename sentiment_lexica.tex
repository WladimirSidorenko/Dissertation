  ...
  \begin{center}
    ...
    \begin{tabular}{p{0.1\columnwidth} % first columm
      ...
      \toprule
          ...
          HL & 14\stddev{5.6} & 19.3\stddev{7} & 15.9\stddev{5.8} & %
          16.7\stddev{9.6} & 9.4\stddev{5.6} & \textbf{11.7}\stddev{6.5} & %
          96.7\stddev{0.7} & 96.6\stddev{0.6} & 96.6\stddev{0.5} & %
          41.4\stddev{3.3} & 93.3\stddev{0.9}\\
...
In order to test how the last factor affected the results obtained by
  ...
  \begin{center}
    ...
    \begin{tabular}{p{0.1\columnwidth} % first columm
      ...
      \toprule
         ...
         \textsc{Seeds Set} & 75.8\stddev{23.8} & 9.1\stddev{5.7} & 15.8\stddev{8.8} & %
          24.4\stddev{41.8} & 1\stddev{1.8} & 1.9\stddev{3.4} & %
          96.3\stddev{0.8} & 99.9\stddev{0.1} & 98.1\stddev{0.4} & %
          38.6\stddev{3.2} & 96.2\stddev{0.8}\\

          HL & 73.7\stddev{23.9} & 9.2\stddev{5.6} & 16\stddev{8.7} & %
          33.1\stddev{44.5} & 1.7\stddev{2.5} & 3.2\stddev{4.7} & %
          96.3\stddev{0.8} & 99.9\stddev{0.1} & 98.1\stddev{0.4} & %
          39.1\stddev{3.5} & 96.2\stddev{0.8}\\

          BG & 75.4\stddev{21.9} & 9.7\stddev{5.6} & 16.7\stddev{8.6} & %
          32.2\stddev{41.1} & 2\stddev{2.6} & 3.7\stddev{4.8} & %
          96.3\stddev{0.8} & 99.9\stddev{0.1} & 98.1\stddev{0.4} & %
          39.5\stddev{3.4} & 96.2\stddev{0.8}\\
