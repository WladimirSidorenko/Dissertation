...
\begin{table*}[thb!]
  \begin{center}
    \bgroup \setlength\tabcolsep{0.35\tabcolsep} \scriptsize
    \begin{tabular}{|p{0.1\textwidth}| % first columm
        *{15}{>{\centering\arraybackslash}p{0.05\textwidth}|}} % next five columns
      \hline
