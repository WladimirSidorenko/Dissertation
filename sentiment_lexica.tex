...
% {
%   \centering
%   \includegraphics[width=\linewidth]{ising-energy-magnetization.png}
% }
...
\begin{figure*}[hbt!]
  ...
  \begin{subfigure}{.45\textwidth}
    \centering
    \mbox{\includegraphics[height=15em]{sentilex_subjectivity}}
    \caption{Subjectivity line}
  \end{subfigure}
  \begin{subfigure}{.45\textwidth}
    \centering
    \mbox{\includegraphics[height=15em]{sentilex_polarity}}
  ...
  two-dimensional vector space]{Visualization of the linear
    ...
    highlighted in \textcolor{highlighter green}{green})}\label{fig:linproj}
\end{figure*}

% \begin{minipage}{0.4\textwidth}
%   \centering
%   \mbox{\includegraphics[height=15em]{sentilex_L_M}}
...
\begin{algorithm}
  \begin{algorithmic}[1]
    ...
    \Else
    \State\vars{score}$_{subj}\gets 1 - \frac{|\vars{p}_{subj}-\vars{O}_{subj}|}{\vars{max\_score}_{subj}}$;
    \EndIf
...
%%       \centering
%%       \includegraphics[width=\linewidth]{sentilex_polarity_not_normed.png}
%%       \caption{Without normalization}\label{snt-lex:fig:nwe-no-norm}
%%     \end{subfigure}%
%%     \begin{subfigure}{.5\textwidth}
%%       \centering
%%       \includegraphics[width=\linewidth]{sentilex_polarity_len_normed.png}
%%       \caption{With length normalization}\label{snt-lex:fig:nwe-len-norm}
%%     \end{subfigure}\\
%%     \begin{subfigure}{.5\textwidth}
%%       \centering
%%       \includegraphics[width=\linewidth]{sentilex_polarity_mean_normed.png}
%%       \caption{With mean normalization}\label{snt-lex:fig:nwe-mean-norm}
%%     \end{subfigure}%
%%     \begin{subfigure}{.5\textwidth}
%%       \centering
%%       \includegraphics[width=\linewidth]{sentilex_polarity_len_mean_normed.png}
...
% \begin{subfigure}{.5\textwidth}
%   \centering
%   \includegraphics[width=\linewidth]{germanet.png}
%   \caption{\textsc{GermaNet}}\label{snt-lex:fig:germanet}
% \end{subfigure}%
% \begin{subfigure}{.5\textwidth}
%   \centering
%   \includegraphics[width=\linewidth]{wordnet.png}
