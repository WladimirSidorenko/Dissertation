...
estimated the negative and positive polarity of a message ($F_p$ and
...
was more than 0.5.  With this method, they achieved an accuracy
...
estimating the overall polarity of a microblog:
\begin{inparaenum}[(i)]
...
solution, yielding an accuracy of 61.74\%.  In the final step,
\citeauthor{Kolchyna:15} also checked whether these lexicon values
could be useful features for an ML-based method.  For this purpose,
they plugged the lexicon scores as additional input traits to a
cost-sensitive SVM classifier~\cite{Masnadi:12}, getting almost five
percent accuracy improvement (from 86.62 to 91.17) on the IMDB movie
review dataset~\cite{Pang:02}.
