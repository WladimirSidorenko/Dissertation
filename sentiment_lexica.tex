...
bigger cluster.% This method achieved an overall accuracy of 82.05\%
...
possible polarity assignments.% reaching 91.5\% accuracy at predicting
% polarity of the manually labeled subjective terms from the General
% Inquirer lexicon \cite{Stone:66}.
