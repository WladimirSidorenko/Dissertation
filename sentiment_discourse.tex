...
juxtapposed semantic orientations.
  ...
  \begin{center}
    ...
    \caption[Evaluation of DASA methods]{Results of discourse-aware
      sentiment analysis methods\\ {\small LCRF~--~latent conditional
        ...
        by last EDU, \textsc{Root}~--~polarity determined by root
        EDU(s), \textsc{No-Discourse}~--~discourse-unaware
        classifier}}
    \label{dasa:tbl:res}
  \end{center}
\end{table}
...
\begin{example}[Error Made by the \textsc{LCRF} System\newline]\label{snt:dasa:exmp:lcrf-error}
  \noindent\textup{\bfseries\textcolor{darkred}{Tweet:}} {\upshape
    $[$Boah , also doch wieder ein Mann , oder ?$]_1$ $[$ODER ?$]_2$ $[$papst$]_3$}\\
...
\begin{example}[Error Made by the \textsc{Last} System]\label{snt:dasa:exmp:last-error}
  \noindent\textup{\bfseries\textcolor{darkred}{Tweet:}} {\upshape ' (
    :'( :'( Die letzte Aussprache war wohl das schwerste Telefonat
    meines gesamten Lebens :'( :'( :'( Aber wir gehen friedlich und
    als}\\
  \noindent ' ( :'( :'( The last talk was probably the most difficult
  call in my entire life :'( :'( :'( But we go apart peacefully and
  as\\[\exampleSep]
  \noindent\textup{\bfseries\textcolor{darkred}{Gold Label:}}\hspace*{4.3em}\textbf{%
    \upshape\textcolor{midnightblue}{negative}}\\
  \noindent\textup{\bfseries\textcolor{darkred}{Predicted Label:}}\hspace*{2em}\textbf{%
  ...
  %% <<<	gold:	negative
  %% >>>	predicted:	neutral
  %% 394487734192316416	' ( :'( :'( Die letzte Aussprache war wohl das schwerste Telefonat
  %% meines gesamten Lebens :'( :'( :'( Aber wir gehen friedlich und als
  %% F ...
\end{example}
...
replacing the probabiities returned by the LBA system with the scores
...
Two other factors which could significantly influence the results of
discourse-aware sentiment systems were the quality of automatic
discourse analysis and the set of RST relations distinguished by the
parsing system. As you might remember from the beginning of this
chapter, while preparing the data for our experiments, we decided to
only differentiate between \textsc{Contrastive} and
...
\begin{table}[h]
  \begin{center}
    ...
    \begin{tabular}{p{0.162\columnwidth} % first columm
      ...
      %% positive       0.83      0.77      0.80       541
      %% negative       0.61      0.12      0.20       220
      %% neutral       0.54      0.89      0.67       351
      %% avg / total       0.70      0.68      0.64      1112
      %% Macro-Averaged F1-Score (Positive and Negative Classes): 50.15%
      %% Micro-Averaged F1-Score (All Classes): 67.6259%
      LCRF & 0.83 & \textbf{0.77} & \textbf{0.8} & %
      0.61 & 0.12 & 0.2 & %
      0.54 & 0.89 & 0.67 & %
      0.502 & 0.676\\
      ...
      %% General Statistics:
      %% precision    recall  f1-score   support
      %% positive       0.85      0.76      0.80       541
      %% negative       0.59      0.13      0.22       220
      %% neutral       0.54      0.89      0.67       351
      %% avg / total       0.70      0.68      0.64      1112
      %% Macro-Averaged F1-Score (Positive and Negative Classes): 50.72%
      %% Micro-Averaged F1-Score (All Classes): 67.5360%
      LMCRF & 0.85  & 0.76 & \textbf{0.8} & %
      0.59 & 0.13 & 0.22 & %
      0.54 & 0.89 & 0.67 & %
      0.507 & 0.676\\
      ...
      %% General Statistics:
      %% precision    recall  f1-score   support
      %% positive       0.84      0.76      0.80       541
      %% negative       0.60      0.17      0.26       220
      %% neutral       0.55      0.88      0.68       351
      %% avg / total       0.70      0.68      0.65      1112
      %% Macro-Averaged F1-Score (Positive and Negative Classes): 53.10%
      %% Micro-Averaged F1-Score (All Classes): 68.1655%
      RDP & 0.84 & 0.76 & \textbf{0.8} & %
      0.6 & 0.17 & 0.26 & %
      0.55 & 0.88 & \textbf{0.68} & %
      \textbf{0.531} & \textbf{0.682}\\

      %% General Statistics:
      %% precision    recall  f1-score   support
      %% positive       0.90      0.07      0.12       541
      %% neutral       0.33      0.99      0.49       351
      %% negative       1.00      0.00      0.01       220
      %% avg / total       0.74      0.35      0.22      1112
      %% Macro-Averaged F1-Score (Positive and Negative Classes): 6.65%
      %% Micro-Averaged F1-Score (All Classes): 34.7122%
      DDR & \textbf{0.9} & 0.07 & 0.12 & %
      0.33 & \textbf{0.99} & \textbf{0.49} & %
      \textbf{1.} & 0.0 & 0.01 & %
      0.067 & 0.347\\

      %% General Statistics:
      %% precision    recall  f1-score   support
      %% positive       0.85      0.54      0.66       541
      %% negative       0.44      0.04      0.07       220
      %% neutral       0.44      0.93      0.60       351
      %% avg / total       0.64      0.56      0.52      1112
      %% Macro-Averaged F1-Score (Positive and Negative Classes): 36.36%
      %% Micro-Averaged F1-Score (All Classes): 56.4748%
      R2N2 & 0.85 & 0.54 & 0.66 & %
      0.44 & 0.04 & 0.07 & %
      0.44 & 0.93 & 0.6 & %
      0.364 & 0.565\\
      ...
      %% General Statistics:
      %% precision    recall  f1-score   support
      %% positive       0.81      0.12      0.21       541
      %% negative       0.50      0.00      0.01       220
      %% neutral       0.33      0.98      0.50       351
      %% avg / total       0.60      0.37      0.26      1112
      %% Macro-Averaged F1-Score (Positive and Negative Classes): 10.92%
      %% Micro-Averaged F1-Score (All Classes): 36.8705%
      WNG & 0.81 & 0.12 & 0.21 & %
      0.5 & 0.0 & 0.01 & %
      0.33 & \textbf{0.98} & 0.5 & %
      0.109 & 0.369\\
      ...
      %% General Statistics:
      %% precision    recall  f1-score   support
      %% positive       0.87      0.41      0.56       541
      %% negative       0.00      0.00      0.00       220
      %% neutral       0.40      0.97      0.56       351
      %% avg / total       0.55      0.51      0.45      1112
      %% Macro-Averaged F1-Score (Positive and Negative Classes): 27.92%
      %% Micro-Averaged F1-Score (All Classes): 50.5396%
      \textsc{Last} & 0.87 & 0.41 & 0.56 & %
      0.0 & 0.0  & 0.0 & %
      0.4 & 0.97 & 0.56 & %
      0.279 & 0.505\\
      ...
      %% General Statistics:
      %% precision    recall  f1-score   support
      %% positive       0.76      0.13      0.22       541
      %% negative       0.00      0.00      0.00       220
      %% neutral       0.33      0.97      0.50       351
      %% avg / total       0.48      0.37      0.26      1112
      %% Macro-Averaged F1-Score (Positive and Negative Classes): 10.79%
      %% Micro-Averaged F1-Score (All Classes): 36.8705%
      \textsc{Root} & 0.76 & 0.13 & 0.22 & %
      0.0 & 0.0 & 0.0 & %
      0.33 & 0.97 & 0.5 & %
      0.108 & 0.369\\
      ...
      %% General Statistics:
      %% precision    recall  f1-score   support
      %% positive       0.84      0.77      0.80       541
      %% negative       0.63      0.15      0.24       220
      %% neutral       0.55      0.88      0.67       351
      %% avg / total       0.70      0.68      0.65      1112
      %% Macro-Averaged F1-Score (Positive and Negative Classes): 52.11%
      %% Micro-Averaged F1-Score (All Classes): 67.9856%

      \textsc{No-Discourse} & 0.84 & \textbf{0.77} & \textbf{0.8} & %
      \textbf{0.63} & 0.15 & 0.24 & %
      0.55 & 0.88 & 0.67 & %
      0.521 & 0.68\\\bottomrule
    \end{tabular}
    \egroup
