...
The growing popularity of online conversation platforms over the last few years
has lead to a dramatic increase in the amount of unstructured text data that
are communicated on these platforms.  As a consequence, dealing with this
...
platform.\footnote{\url{https://twitter.com/}} We investigate language
specifics of Twitter messages (tweets) from both linguistic and computational
sides.  From the linguistic perspective, we analyze which language phenomena
actually account for the notoriously peculiar style of tweets, how frequent
those phenomena are, and what role they play in the online communication.  From
the computational point of view, we evaluate to what extent differences in the
language style can affect the performance of the existing NLP approaches and
what techniques can help improve this performance in future.
