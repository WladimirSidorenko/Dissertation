...
**** IN-PROGRESS I would have liked to know more about how inference and learning was implemented in these structures, since the "off-the-shelf" Viterbi and forward-backward algorithms are not immediately applicable to Semi-Markov and Tree-structured models.
*** DONE Chapter 5
...
*** TODO Clarify the gold format


** TODO Re-read the thesis
