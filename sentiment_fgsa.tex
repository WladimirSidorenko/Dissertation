...
Table~\ref{snt-fgsa:tbl:rnn-res}.  As we can see from the table, the
LSTM model shows generally better scores than the GRU system on both
training and test data.  The only aspect at which it is slightly
outperfomed by the latter approach is the precision of sentiment
spans, which, however, can be more than compensated for by a higher
recall.  Moreover, the overfitting effect is much less pronounced than
in the CRF case (where the \F scores on training and test data
differed by a factor of three).  Nonetheless, both RNN systems achieve
lower results than the linear-chain CRFs, which indicates the fact
that deeply learned features still cannot capture the full extent of
information which a human expert can encode with manually defined
attributes.
...
training procedure at a time, and reestimated the scores on the
...
assign the \texttt{sentiment} label to complete syntactic or
...
its respective target.  Since none of the tested methods could
...
labels: since \texttt{sentiment} tags only get assigned to
...
lexical ones---or learned embeddings.  However, on the other hand,
such short spans lead to disrupted label chains for opinion-related
elements, making sentiment tags be far apart from the spans of the
respective sources and targets.  Consequently, these latter classes
suffer from the lack of context and become heavily dependent on the
state attributes too.  Although, this time, the effect of these
features is rather negative, since, in contrast to polar terms, being
a holder or target of an opinion is not an inherent property of a
lexical expression, but arises from the context which this expression
appears in.
...
% Tag        Precision    Recall F-Measure
% O             79.96%    80.03%    79.99%
% SENTIMENT     34.18%    47.72%    39.83%
% SOURCE        29.79%    25.06%    27.22%
% TARGET        26.50%    45.30%    33.44%

% Tag        Precision    Recall F-Measure
% O             84.72%    90.62%    87.57%
% SENTIMENT     57.87%    72.89%    64.52%
% SOURCE        43.78%    71.41%    54.28%
% TARGET        56.50%    69.33%    62.26%

% Tag        Precision    Recall F-Measure
% O             86.00%    87.80%    86.89%
% SENTIMENT     54.88%    75.08%    63.41%
% SOURCE        47.69%    67.65%    55.94%
% TARGET        46.39%    77.69%    58.09%

% Dev Set
% Tag        Precision    Recall F-Measure
% O             75.82%    85.19%    80.23%
% SENTIMENT     29.97%    28.29%    29.11%
% SOURCE        30.34%    27.00%    28.57%
% TARGET        21.23%    20.78%    21.00%

% Tag        Precision    Recall F-Measure
% O             76.66%    85.62%    80.89%
% SENTIMENT     31.40%    26.14%    28.53%
% SOURCE        28.37%    41.75%    33.78%
% TARGET        26.24%    18.44%    21.66%

% Tag        Precision    Recall F-Measure
% O             76.11%    81.96%    78.92%
% SENTIMENT     29.00%    26.98%    27.96%
% SOURCE        27.62%    37.50%    31.81%
% TARGET        22.38%    23.27%    22.82%

%% Order 3
% Train Set
% Tag        Precision    Recall F-Measure
% O             83.94%    83.93%    83.93%
% SENTIMENT     45.33%    64.52%    53.25%
% SOURCE        38.18%    40.19%    39.16%
% TARGET        37.10%    65.11%    47.27%

% Tag        Precision    Recall F-Measure
% O             82.26%    87.43%    84.76%
% SENTIMENT     42.69%    65.16%    51.59%
% SOURCE        35.61%    37.49%    36.52%
% TARGET        47.47%    51.20%    49.26%

% Dev Set
% Tag        Precision    Recall F-Measure
% O             77.12%    83.11%    80.01%
% SENTIMENT     29.10%    26.74%    27.87%
% SOURCE        31.37%    31.50%    31.44%
% TARGET        22.21%    22.03%    22.12%

% Tag        Precision    Recall F-Measure
% O             75.60%    87.57%    81.15%
% SENTIMENT     31.34%    27.84%    29.49%
% SOURCE        28.16%    28.40%    28.28%
% TARGET        28.09%    16.18%    20.54%
...
% Tag        Precision    Recall F-Measure
% O             84.77%    89.75%    87.19%
% SENTIMENT     52.93%    73.87%    61.67%
% SOURCE        43.66%    73.42%    54.76%
% TARGET        52.95%    70.96%    60.65%
...
% Tag        Precision    Recall F-Measure
% O             76.00%    84.78%    80.15%
% SENTIMENT     27.00%    22.51%    24.55%
% SOURCE        25.75%    37.50%    30.53%
% TARGET        20.13%    16.70%    18.25%
