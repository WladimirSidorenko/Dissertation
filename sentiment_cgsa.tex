...
by~\citet{Riloff:03}, many of the linguistic expressions which
actually correlate with the subjectivity and polarity of a sentence
are very unlikely to be included into a sentiment lexicon by a human
expert.  As a consequence of this, with the emergence of new manually
annotated corpora, lexicon-based systems have gradually been
...
\todo[inline]{Gamon, 2004}

In (Gamon et al., 2005), a semi-supervised learning algorithm was used
to learn from a small set of labeled sentences and a large set of
unlabeled sentences. The learning algorithm was based on Expectation
Maximization (EM) using the naive Bayes as the base classifier (Nigam
et al., 2000). This work performed three-class classification,
positive, negative, and ``other'' (no opinion or mixed opinion).

\todo[inline]{Wiebe et al., 2004}

\todo[inline]{Wilson, Wiebe and Hwa, 2004}

\todo[inline]{Wilson, Wiebe and Hwa, 2006}

\todo[inline]{Pang and Lee, 2004}
...
\todo[inline]{Cui, Mittal and Datar, 2006}

\todo[inline]{Ng, Dasgupta and Arifin, 2006}

\todo[inline]{Abbasi, Chen and Salem, 2008}

\todo[inline]{Li, Zhang and Sindhwani, 2009}

\todo[inline]{Dasgupta and Ng, 2009}

\todo[inline]{Li et al., 2011}

\todo[inline]{Zhou, Chen and Wang, 2010}

\todo[inline]{Mejova and Srinivasan, 2011}

\todo[inline]{Nakagawa, Inui and Kurohashi, 2010}

\todo[inline]{Bickerstaffe and Zukerman, 2010}

\todo[inline]{Li et al., 2010}

\todo[inline]{Bespalov et al., 2011}
