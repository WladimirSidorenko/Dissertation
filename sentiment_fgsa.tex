...
A sample annotation analyzed in compliance with this rule is shown
below:
...
denotes the total number of spans automatically labeled with the given
tag.

Similarly to that, the recall of the assignment was estimated as:
\begin{equation*}
...
also penalizes for erroneous and spurious annotations, we decided to
use this measure throughout our subsequent experiments.
