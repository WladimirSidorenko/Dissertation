...
Moreover, besides computing the polarity scores $F_p$ and $F_n$,
...
The authors considered a microblog as neutral if its absolute polarity
was less than 25 and the subjectivity value was not greater than 0.5.
Otherwise, they assigned a positive or negative label to this message
depending on the sign of the polarity score.  With this approach,
\citeauthor{Jurek:15} achieved an accuracy of~77.3\% on the manually
annotated subset of \citeauthor{Go:09}'s corpus and reached 74.2\% on
the IMDB review corpus~\cite{Maas:11}.
  ...
  \begin{center}
    ...
    \begin{tabular}{p{0.162\columnwidth} % first columm
      ...
      Precision & Recall & \F{} & & \\\midrule
       ...
       % positive       0.41      0.08      0.14       680
       % negative       0.25      0.11      0.15       287
       % neutral       0.36      0.82      0.50       558
       % avg / total       0.36      0.36      0.27      1525
       % Macro-Averaged F1-Score (Positive and Negative Classes): 14.66%
