...
head usually grammatically dominates all its dependents.  The same
kind of structure can also be observed in discourse, where one of the
sentences might express the core idea of the whole text.
