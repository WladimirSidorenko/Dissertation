...
\begin{table}[h]
  \begin{center}
    ...
    \begin{tabular}{p{0.22\columnwidth} % first columm
      ...
      \textsc{PCC} & 0.534 & 0.776 & 0.326\\

      \citet{Heerschop:11} & 0.51 & 0.774 & 0.361\\

      \citet{Zhou:11} & 0.501 & 0.776 & 0.388\\

      \citet{Chenlo:13} & 0.505 & 0.769 & 0.362\\

      \citet{Bhatia:15} & 0.512 & 0.777 & 0.396\\\bottomrule
\end{tabular}
    \egroup
