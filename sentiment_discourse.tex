...
the results of our proposed methods are significanlty limited by two
key factors:
\begin{inparaenum}[(i)]
...
discourse-unware method.  The most surprising finding for us though is
...
\begin{itemize}
  ...
  \item to substantiate our claims and to see whether the
    ...
    elementary discourse units usinf the SVM-based segmenter
  ...
  \item we could, however, improve on these results and also
    ...
    increasing the resukt on SB10k to 0.56 macro-\F{};
