...
method of~\citet{Socher:13}, recursively computing the polarity score
$\psi$ of each discourse unit $i$ as:
\begin{equation*}
...
the nucleus and and satellite nodes of the $i$-th vertex.  This
approach achieved formidable 84.1\% accuracy for the two-class
prediction on the moview review corpus of~\citet{Pang:04} and reached
