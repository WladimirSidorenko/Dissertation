...
The first avenue we are going to explore with the help of the obtained
corpus data is that of the automatic prediction of polar lexical terms
or, in other words, emotional expressions.  To this end, we will first
estimate the recall, precision, and $F1$-score of the sentiment lexica
that currently exist German.  Since all of these resources were
...
The results of this method are shown in Table~\ref{snt-lex:tbl:swn}.
...
The results of this method are shown in Table~\ref{snt-lex:tbl:ispn}.
