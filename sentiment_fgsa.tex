...
\cite{Rabiner:90}---a particular case of the more general belief
propagation method \cite[cf.][p.~81]{Barber:12}.
...
of the FB method with the summation over alternative states replaced
by the maximum operator (hence the other name for this algorithm
``max-product'').

The forward pass of this algorithm with the
summation
