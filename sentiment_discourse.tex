...
\begin{figure}[htb!]
  ...
  \caption[Probability distributions computed by RDP]{Probability
    ...
    Process\\ {(higher probability regions are highlighted in red;
      ...
      $\boldsymbol{\sigma}$ represent the paremeters of the resulting
      joint distribution shown in the
...
shows very competitive scores, yielding the best $F_1$-results for the
