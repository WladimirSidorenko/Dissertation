...
given in Table~\ref{snt-fgsa:tbl:narrow-wide}.
\begin{table*}[hbt!]
  \begin{center}
    \bgroup \setlength\tabcolsep{0.1\tabcolsep}\scriptsize
    \begin{tabular}{p{0.162\columnwidth} % first columm
...
As we can see from the table, the wide approach generally leads to
...
\F-values for sentiments are twice as high as in the wide case, the
...
with the wide interpretation versus 0.24~\F{} achieved by this model
...
words appear in subjective rather than objective contexts, but cannot
tell us for sure whether they actually do or not.  This is especially
so, when the actual polar term appears at the other end of the
sentence.
...
% Tag        Precision    Recall F-Measure
% O             76.24%    80.65%    78.38%
% SENTIMENT     27.67%    34.46%    30.69%
% SOURCE        25.48%    36.78%    30.11%
% TARGET        23.74%    24.72%    24.22%

% Tag        Precision    Recall F-Measure
% O             75.73%    82.88%    79.14%
% SENTIMENT     31.91%    37.32%    34.41%
% SOURCE        32.94%    27.50%    29.98%
% TARGET        25.87%    22.66%    24.15%

% Tag        Precision    Recall F-Measure
% O             75.05%    78.71%    76.83%
% SENTIMENT     28.31%    33.89%    30.85%
% SOURCE        20.74%    47.08%    28.80%
% TARGET        23.07%    27.58%    25.12%
