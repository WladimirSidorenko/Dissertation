...
determine the overall polarity of a message.  Traditionally, this task
has been addessed with either of three popular groups of methods:
\begin{inparaenum}[(i)]
...
preparation step, we proceed to the actual estimation of the lexicon-,
...
To estimate the quality of the compared systems, we use two
established evaluation metrics which are commoly applied for measuring
CGSA results: macro-averaged \F-score over two major polarity
classes~(positive and negative), which was used in the sentiment
analysis track of the SemEval
...
\todo[inline]{Micro-averaged \F-score (Accuracy)}

\todo[inline]{Macro-averaged \F-score over two classes}
