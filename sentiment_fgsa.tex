...
represent probabilities of the lables (as their elements could also be
...
\begin{figure*}[thb]
  ...
  \caption{\emph{Factor graphs of different CRF topologies.}\\Blank
    ...
    transition factors).\label{fig:snt:ho-crf}}
\end{figure*}
...
\item because the number of the input features in the RNN methods was
  ...
  (100 + 1 lexicon score) whereas, in the CRF case, the number of
...
Furtermore, a closer look at each of the settings in our experiments
revealed that:
\begin{itemize}
...
context would be autmatically equalized with the sum of the state
