...
\item and, finally, the \emph{avoidance of the label bias problem},
  ...
  \begin{example}[Label Bias Problem]
    ...
    \end{tikzpicture}
    \captionof{figure}{Feature weights for states and transitions of
      the part-of-speech example.\label{fig:snt:memm-crf}}
    \end{center}
...
\begin{figure*}[thb]
  ...
  \end{subfigure}
  \caption[Factor graphs of different CRF topologies.]{Factor graphs
    of different CRF topologies.\\\emph{Blank nodes represent
    unobserved variables; gray circles denote observed input; feature
    functions are shown as squares (with black squares representing
    state features, and red rectangles denoting transition
    factors).}\label{fig:snt:ho-crf}}
\end{figure*}
...
\begin{table}[hbt]
  \begin{center}
    ...
    model.]{Top ten state and transition features learned by the CRF
...
\item replaced syntactically integrated Twitter phenomena (@-mentions,
  ...
  representing their semantic classes (e.g., ``\%Username'' for
...
(e.g., positive polarity) were shared among all of the respective
subclasses (e.g., positive sentiments with high, low, and middle
intensities).
