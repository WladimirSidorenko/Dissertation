...
with different analyses of \markable{sentiment}s is shown in
...
all, she also automatically disagreed on the \markable{target} tag.
...
ideally, two \markable{sentiment} elements had to be labeled in this
...
number of \markable{sentiment}s occur in tweets pertaining to federal
elections and in messages representing casual everyday conversations.
A similar tendency is observed for \markable{polar term}s, but in this
...
were preselected using the sentiment lexicon, whereas \markable{polar
  term}s are easiest to analyze in microblogs that contain emoticons.
